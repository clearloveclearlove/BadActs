...
class Trainer(object):
    ...
    def __init__(
        ...
        poison_dataset: Optional[str] = "",
        poison_model: Optional[str] = "",
        **kwargs):
        ...
        self.save_path = os.path.join(save_path, f'{poison_setting}-{poison_method}-{poison_rate}-{poison_dataset}-{poison_model}')
